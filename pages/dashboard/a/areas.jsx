...
const Item = ({
  ...
  let subCases;
  if (placeholderKey) {
    subCases = data.cases.map((cas) => cas.subarea);
  }
    ...
    <>
      <div className="form-group">
        ...
        <input
          ...
          type="text"
          value={placeholderKey ? subCases : valueData}
        />
            ...
            {!isFormOpen ? (
              <>
                <div>
                  ...
                  >
                    Añadir {!selectedArea ? "área" : "subarea"}
                  </button>
                </div>
              ...
              <>
                ...
                {selectedItem ? (
                  ...
                  <>
                    <AreasUpdate
                      area={
                        this.state.formValues ? this.state.formValues.area : ""
                      }
                      onFormSubmit={this.onFormSubmit}
                      bindSubmitForm={this.bindSubmitForm}
                    />
...
Areas.getInitialProps = async (ctx) => {
  ...
  if (ok) {
    return {initialValues: data.initialValues.areas, userid: userid};
  }
