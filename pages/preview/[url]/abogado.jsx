      ...
      {lawyer !== null ? (
        <>
          ...
          <MobileHeading className="d-md-none">
            <div className="container d-flex">
              <div className="d-md-none mr-auto">
                <Link
                  href={`${
                    value.lawyer.idSub
                      ? `/landing-preview/${value.lawyer.nameSub}?id=${value.lawyer.idSub}`
                      : `/preview/[url]/#lawyers`
                  }`}
                  as={`${
                    value.lawyer.idSub
                      ? `/landing-preview/${value.lawyer.nameSub}?id=${value.lawyer.idSub}`
                      : `/preview/${value.lawyer.url}/#lawyers`
                  }`}
                >
                  <a>
                    <svg
            ...
            <Media className="container-fluid">
              <ImageWrapper>
                {lawyer.image ? (
...
LawyerPage.getInitialProps = ({query, ...ctx}) => {
  if (!query.id) {
    ctx.res.redirect(`/preview/${query.url}`);
  }
