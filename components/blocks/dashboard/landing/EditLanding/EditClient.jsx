...
import FormClients from "../formEdit/FormClients";
...
`;
export default function EditClient({reload, id, testimonials, userid}) {
      ...
      <div className="form-container">
        <div className="load__row mb-4">
          <h1 className="heading">
            Edita la sección
            <br />
            <strong className="heading--blue">nuestros clientes</strong>
          </h1>
        </div>
      </div>
      {activeForm ? (
        <>
          ...
          <div style={{position: "relative"}} className="text-center mb-5 mt-5">
            {" "}
            <p style={{fontSize: "1.7rem"}}>Nuevo testimonio</p>
            <button
              onClick={() => {
                setActiveForm(null);
              }}
