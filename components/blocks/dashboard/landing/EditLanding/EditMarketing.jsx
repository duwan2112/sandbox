...
import {Alert, User} from "../../../../../components/contexts/index";
...
export default function EditMarketing({seoInfo, reload, id, url, userid}) {
  ...
  const onSubmitInfo = (e) => {
    const {direction, areas, location, money} = e;
    window.location.href = `mailto:marketingabogados.hfma@gmail.com?Subject=Informacion Marketing &body=Direccion web: ${direction}%0AAreas: ${areas}%0ALocalizacion: ${location}%0APresupuesto: ${money}€`;
  };

  const onSubmitSeo = async (e) => {
    const {ok} = await putAsync(
      ...
      <div className="form-container">
        <div className="load__row mb-4">
          <h1 className="heading">
            Edita la sección
            <br />
            <strong className="heading--blue">compañia marketing</strong>
          </h1>
        </div>
      </div>
          ...
          <div className="seccion-text">
            <div>
              ...
              <p>
                ...
                marketingabogados.hfma@gmail.com, selecciona el “nivel de acceso
                estandar” y pulsa el botón para confirmar
              </p>{" "}
            </div>{" "}
          </div>
        )}
          ...
          <div className="seccion-text">
            <div>
              ...
              <p>
                ...
                campaña escríbenos un correo a marketingabogados.hfma@gmail.com
                indicando el nuevo importe y la dirección de tu web.
              </p>{" "}
              <br /> <br />
              <p className="faq">
                ...
                return (
                  <Form>
                    ...
                    <FormGroup
                      ...
                      asInput="textarea"
                    />
                    <StyledForm value={values.description.length} size={156} />
                    <div className="form-group btn-submit">
                      <input type="submit" value="Enviar información" />
                    </div>
                  </Form>
